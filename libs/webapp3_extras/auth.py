...
#:     Default is :class:`webapp3_extras.appengine.auth.models.User`.
#:
#: session_backend
...
default_config = {
    'user_model':      'webapp3_extras.appengine.auth.models.User',
...
class AuthStore(object):
    ...
    def user_model(self):
        ...
        if isinstance(cls, six.string_types):
            cls = self.config['user_model'] = webapp3.import_string(cls)
...
_store_registry_key = 'webapp3_extras.auth.Auth'
#: Key used to store :class:`Auth` in the request registry.
_auth_registry_key = 'webapp3_extras.auth.Auth'
