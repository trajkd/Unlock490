...
"""
webapp3_extras.appengine.sessions_memcache
==========================================
...
class MemcacheSessionFactory(sessions.CustomBackendSessionFactory):
    ...
    :meth:`webapp3_extras.sessions.SessionStore.get_session`::

        from webapp3_extras import sessions_memcache
    ...
    See in :meth:`webapp3_extras.sessions.SessionStore` an example of how to
    make sessions available in a :class:`webapp3.RequestHandler`.
    """
