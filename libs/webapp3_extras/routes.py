...
"""
webapp3_extras.routes
=====================

Extra route classes for webapp3.
"""
import six
...
class DomainRoute(MultiRoute):
    ...
    The template follows the same syntax used by :class:`webapp3.Route` and
    ...
    def __init__(self, template, routes):
        ...
        :param template:
            ...
            See a syntax description in :meth:`webapp3.Route.__init__`.
        :param routes:
            A list of :class:`webapp3.Route` instances.
        """
    ...
    def regex(self):
        regex, reverse_template, args_count, kwargs_count, variables = \
            webapp3._parse_route_template(self.template,
                                          default_sufix='[^\.]+')
        return regex
...
class PathPrefixRoute(NamePrefixRoute):
    ...
    def regex(self):
        regex, reverse_template, args_count, kwargs_count, variables = \
            webapp3._parse_route_template(self.prefix + '<:/.*>')
        return regex


class RedirectRoute(webapp3.Route):
    ...
    def __init__(self, template, handler=None, name=None, defaults=None,
        ...
        :param redirect_to:
            ...
            equivalent::
                ...
                route = Route('/foo', handler=webapp3.RedirectHandler,
                              defaults={'_uri': '/bar'})
        ...
        if redirect_to is not None:
            ...
            self.handler = webapp3.RedirectHandler
    ...
    def _get_redirect_route(self, template=None, name=None):
        ...
        new_route = webapp3.Route(template, webapp3.RedirectHandler,
                                  defaults=defaults)
        return new_route
