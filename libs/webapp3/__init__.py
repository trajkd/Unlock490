...
if os.environ.get('APPENGINE_RUNTIME') != 'python27':  # pragma: no cover
    try:
        ...
        # Running webapp3 outside of GAE.
        pass
...
class RequestHandler(object):
    ...
    def __init__(self, request=None, response=None):
        ...
        Also in webapp dispatching is done by the WSGI app, while webapp3
...
class Webapp3HandlerAdapter(BaseHandlerAdapter):
    """An adapter to dispatch a ``webapp3.RequestHandler``.
...
class Router(object):
    ...
    def default_adapter(self, handler):
        ...
        This way webapp3 can support, for example, a :class:`RequestHandler`
        ...
        if inspect.isclass(handler):
            if _webapp and issubclass(handler, _webapp.RequestHandler):
                ...
                # Default, compatible with webapp3.RequestHandler.
                adapter = Webapp3HandlerAdapter
        else:
            # A "view" function.
...
class WSGIApplication(object):
    ...
    def set_globals(self, app=None, request=None):
        ...
        If :mod:`webapp3_extras.local` is available, the app and request
        ...
        If :mod:`webapp3_extras.local` is not available, app and request will
